...
library PancakeLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"359c820af304549fa0abee64abab3fbbf7db51f106a5de0f441da476ba1d55d4" // init code hash
                    )
                )
            )
        );
    ...
    function quote(
        ...
        require(
            ...
            "SpiritLibrary: INSUFFICIENT_LIQUIDITY"
        );
...
contract SpiritRouter is IPancakeRouter02 {
        ...
        if (reserveA == 0 && reserveB == 0) {
            ...
            if (amountBOptimal <= amountBDesired) {
                require(
                    ...
                    "SpiritRouter: INSUFFICIENT_B_AMOUNT"
                );
                ...
                require(
                    ...
                    "SpiritRouter: INSUFFICIENT_A_AMOUNT"
                );
    ...
    {
        require(
            !IPancakeFactory(factory).locked(),
            "SpiritRouter: Permission Denied"
        );
        ...
        returns (uint256[] memory amounts)
    {
        ...
        require(
            ...
            "SpiritRouter: EXCESSIVE_INPUT_AMOUNT"
        );
        TransferHelper.safeTransferFrom(
            path[0],
            msg.sender,
