...
contract PancakePair is IPancakePair, PancakeERC20 {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Spirit: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Spirit: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Spirit: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "Spirit: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
